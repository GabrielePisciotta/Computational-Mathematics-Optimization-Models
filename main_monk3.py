...
def main():
    ...
    ds = "results/Monk3" #<--- cambiamo qui così propaghiamo il dataset
    makedirs(ds, exist_ok=True)

    print("Loading datasets...")
    X_train, Y_train, X_test, Y_test = load_monk_dataset(3)

    print("Building LBFGS model ... ")

    model = NeuralNetwork(LBFGS(m=3, c1=1e-4, c2=0.9, threshold_gradient_norm=0.00001, threshold_loss=0.01),
